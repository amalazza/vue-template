<template>
    <div>
        <div class="row">
            <div class="carousel-cell wd-18 block2 bg0" v-for="(item, index) in bukuMaster" :key="index">
                <div class="block2-pic hov-img2 label-new " data-label="100%">
