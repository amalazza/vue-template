        ...
        <div class="row">
            ...
            <div class="col-md-9 p-lr-0 text-left">
                <div class="p-tb-15 p-lr-50">
                    <div class="media">
                        <img class="mr-3 bantuan-icon"
                            src="https://www.eurekabookhouse.co.id/assets/front/images/icons/ecommerce/048-bill.svg"
                            alt="Generic placeholder image">
                        <div class="media-body">
                            <h5 class="mtext-101 mt-0">Pembayaran</h5>
                            <span class="stext-107">Sekilas tentang pembayaran</span>
                        </div>
                    </div>
                </div>
                <hr class="m-tb-0">
                <div class="p-tb-15 p-lr-50">
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="pembayaran/konfirmasi-pembayaran">Konfirmasi Pembayaran</a>
                        </li>
                    </ul>
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="pembayaran/transfer-tidak-sesuai-tagihan">Transfer Tidak
                                Sesuai Tagihan</a>
                        </li>
                    </ul>
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="pembayaran/pesanan-saya-belum-diproses-penjual">Pesanan saya
                                belum diproses penjual</a>
                        </li>
                    </ul>
                </div>
            </div>
