        ...
        <div class="row">
            <div class="col-md-3 bor9 text-left">
                <div id="gede-saja" class="list-group">
                    <router-link :to="'/BantuanEBH/tentang'" class="list-group-item list-group-item-action">Tentang Eureka Bookhouse</router-link>
                    <router-link :to="'/BantuanEBH/bantuanregistrasi'" class="list-group-item list-group-item-action">Registrasi </router-link>
            ...
            <div class="col-md-9 p-lr-0 text-left">
                <div class="p-tb-15 p-lr-50">
                    <div class="media">
                        <img class="mr-3 bantuan-icon"
                            src="https://www.eurekabookhouse.co.id/assets/front/images/icons/ecommerce/026-delivery-1.svg"
                            alt="Generic placeholder image">
                        <div class="media-body">
                            <h5 class="mtext-101 mt-0">Kerja Sama</h5>
                            <span class="stext-107">Sekilas tentang kerja sama</span>
                        </div>
                    </div>
                </div>
                <hr class="m-tb-0">
                <div class="p-tb-15 p-lr-50">
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="kerja-sama/menjadi-official-store">Menjadi Official Store</a>
                        </li>
                    </ul>
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="kerja-sama/kebijakan-produk-dilarang">Kebijakan Produk
                                Dilarang</a>
                        </li>
                    </ul>
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="kerja-sama/syarat-layanan-official-store">Syarat Layanan
                                Official Store</a>
                        </li>
                    </ul>
                </div>
