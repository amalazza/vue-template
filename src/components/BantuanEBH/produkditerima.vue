...
<section class="mt-3 bg0 text-left">
    <div class="container">
        <div class="row">
            <div class="col-md-3 bor9">
                <div id="gede-saja" class="list-group">
                    ...
                    <router-link :to="'/BantuanEBH/produkditerima'" class="list-group-item list-group-item-action">Produk Diterima
                    </router-link>
            ...
            <div class="col-md-9 p-lr-0 text-left">
                <div class="p-tb-15 p-lr-50">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h5 class="mtext-101 mt-0">Produk Diterima</h5>
                            <span class="stext-107">Sekilas tentang produk diterima</span>
                        </div>
                    </div>
                </div>
                <hr class="m-tb-0">
                <div class="p-tb-15 p-lr-50">
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="produk-diterima/apa-itu-race-coin">Apa itu Race Coin</a>
                        </li>
                    </ul>
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="produk-diterima/saya-telah-menerima-pesanan">Saya telah
                                menerima pesanan</a>
                        </li>
                    </ul>
                </div>
