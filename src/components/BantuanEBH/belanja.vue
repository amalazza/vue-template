        ...
        <div class="row">
            ...
            <div class="col-md-9 p-lr-0 text-left">
                <div class="p-tb-15 p-lr-50">
                    <div class="media">
                        <img class="mr-3 bantuan-icon"
                            src="https://www.eurekabookhouse.co.id/assets/front/images/icons/ecommerce/023-gift.svg"
                            alt="Generic placeholder image">
                        <div class="media-body">
                            <h5 class="mtext-101 mt-0">Belanja</h5>
                            <span class="stext-107">Sekilas tentang belanja</span>
                        </div>
                    </div>
                </div>
                <hr class="m-tb-0">
                <div class="p-tb-15 p-lr-50">
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="belanja/ada-masalah-pada-promo--cashback--voucher">Ada
                                masalah pada promo/ cashback/ voucher</a>
                        </li>
                    </ul>
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="belanja/menambahkan-barang-ke-keranjang">Menambahkan barang
                                ke keranjang</a>
                        </li>
                    </ul>
                    <ul>
                        <li class="m-tb-15">
                            <a class="stext-101 cl2" href="belanja/melakukan-checkout">Melakukan Checkout</a>
                        </li>
                    </ul>
                </div>
            </div>
