                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <h1 class="ltext-102 cl2 p-t-28">
                            Cari Sayuran Organik sekarang lebih mudah, ada di eurekabookhouse.co.id </h1>
                            ...
                            <div class="flex-i flex-w flex-m stext-111 cl2">
                                ...
                                <div id="share" class="m-l-50-lg">
                                    <a class="fs-14 badge p-all-5 hov-cl0 facebook customer share"
                                        href="https://www.facebook.com/sharer.php?u=https://www.eurekabookhouse.co.id/blog/read/cari-sayuran-organik-sekarang-lebih-mudah--ada-di-eurekabookhouse-co-id"
                                        target="_blank"><i class="fa fa-facebook"></i></a>
                                    <a class="fs-14 badge p-all-5 hov-cl0 twitter customer share"
                                        href="http://twitter.com/share?url=https://www.eurekabookhouse.co.id/blog/read/cari-sayuran-organik-sekarang-lebih-mudah--ada-di-eurekabookhouse-co-id&amp;text=Blog: Cari Sayuran Organik sekarang lebih mudah, ada di eurekabookhouse.co.id &amp;hashtags=eurekabookhouse"
                                        title="Twitter share" target="_blank"><i class="fa fa-twitter"></i></a>
                                    <a class="fs-14 badge p-all-5 hov-cl0 googleplus customer share"
                                        href="https://plus.google.com/share?url=https://www.eurekabookhouse.co.id/blog/read/cari-sayuran-organik-sekarang-lebih-mudah--ada-di-eurekabookhouse-co-id"
                                        title="Google Plus Share" target="_blank"><i class="fa fa-google-plus"></i></a>
                                </div>
                            </div>
                            <div class="flex-r-m">
                                <span class="stext-107 text-center"><i class="fa fa-eye"></i> 2910</span>
                            </div>
                        </div>
                        <div class="wrap-pic-w how-pos5-parent">
                            <img src="https://cdn.eurekabookhouse.co.id/ebh/blog/imgBlogs9_131345.png" alt="IMG-BLOG"
                                class="blog-read-pic">
                        ...
                        <div class="p-r-0-lg">
                            <div>
                                <div class="isi_blog ctext-101 fs-18 cl2 p-b-26">
                                    <p>Pengertian <strong>Sayur Organik Sayuran organik</strong> adalah <strong>sayuran</strong>
                                        yang dibudidayakan secara alami tanpa ada bantuan bahan kimia. ... Pupuk yang diberikan
                                        untuk <strong>sayuran</strong> berasal dari pupuk <strong>organik</strong>, seperti
                                        kompos atau pupuk kandang, bukan pupuk kimia. Pembasmian hama juga tidak menggunakan
                                        pestisida dari bahan kimia.</p>
                                </div>
                            </div>
