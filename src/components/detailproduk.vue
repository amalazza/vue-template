		...
		<div class="bg0 bor4 mb-3 bs1">
			<div class="row">
				<div class="p-all-20 col-12 col-md-4 col-lg-4"><div class="zoom-gallery">
								...
								<a href="https://cdn.eurekabookhouse.co.id/ebh/product/all/We bare bear POCKET BACKPACK BROWN.jpg">
<img src="https://cdn.eurekabookhouse.co.id/ebh/product/all/We bare bear POCKET BACKPACK BROWN.jpg" style="width: 300px; height: 350px;"/>
							</a>
							</div>
											</div>
                                                </div>
				<div class="col-md-6 col-lg-8 p-b-10">
					<div class="p-all-20 m-b-10 text-left">
						...
						<span class="stext-107"><i class="fa fa-eye"></i> Dilihat: 395</span>
					</div>

					<div class="bg6 bor8 p-all-5">
						<span class="cl2">
								<span class="stext-106"><s>Rp.249.000</s></span>								
                                <div class="flex-m">
									<span class="cl13 ltext-106">Rp.199.200</span>
		...
		<div class="bg0 bor4 mb-3 p-all-20 col-md-12 flex-w">
			...
			<div class="desk-toko text-center bor9 col-md-2 col-4 flex-c-m">
				<p class="stext-101 cl1"><i class="fa fa-inbox"></i> 7154<br> <span class="cl8">Produk</span></p>
			</div>
			<div class="desk-toko text-center col-md-2 col-4 flex-c-m">
				<p class="stext-101 cl1"><i class="fa fa-star"></i> 4.4<br> <span class="cl8">Penilaian</span></p>
			</div>
            </div>
			...
			<div>
				...
				<b-tabs content-class="mt-3" fill>
					<b-tab title="Deskripsi" active><div class="tab-pane fade in active" id="tab1default"> 
						<div class="ctext-101 fs-18 cl2 text-left">
							<div class="cl2">
								<h4 class="mtext-112 cl2 m-b-15"> Deskripsi </h4> 
								<p>Tas Ransel Backpack Anak We Bare Bears<br />
								100% brand new & high quality<br />
								Lovely cute design</p>
					...
					<b-tab title="Spesifikasi">					<h4 class="mtext-112 cl2 m-b-15 text-left"> Spesifikasi </h4> 
